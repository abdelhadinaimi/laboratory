...
<head>
  ...
  <title>LRI | Modifier un projet</title>
  ...
  <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="pub.php">Projets</a></li>
                ...
                <legend><center><h2><b>Modifier projet</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="nom" class="form-control" value="La QOS d'un lien satellite pour l'accès internet" type="text">
                          </div>
                        </div>
                  </div>  
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer">
                        <div style="width: 70%">
                          <textarea class="form-control" rows="3" value="Résumé..."></textarea>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="nom" class="form-control" value="Société B , Société C" type="text">
                          </div>
                        </div>
                  </div> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 inputGroupContainer">
                      <div style="width: 70%">
                        <select class="form-control select2 " multiple="multiple" data-placeholder="Selectionnez les Membres">
                          <option>Membre1</option>
                          <option>Membre2</option>
                          <option>Membre3</option>
                          <option>Membre4</option>
