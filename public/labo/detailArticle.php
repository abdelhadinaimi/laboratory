...
<head>
  ...
  <title>LRI | Détails Articles</title>
  ...
  <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="thèses.php">Articles</a></li>
           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="box-body">
                  ...
                  <div class="col-md-9">
                    <p class="text-muted">
                      Le résumé ici:  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque.
                    </p>
                  </div>
                  <div class="col-md-3">
                    <strong>Type</strong>
                  ...
                  <div class="col-md-3">
                    <strong><i class="fa fa-user margin-r-5"></i> Membres</strong>
                  </div>
                  <div class="col-md-9">
                    <a href="#">Le nom du membre ici</a>
                  </div>
