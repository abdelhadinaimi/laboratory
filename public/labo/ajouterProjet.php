...
<head>
  ...
  <title>LRI | Ajouter un projet</title>
                ...
                <legend><center><h2><b>Nouveau projet</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="nom" class="form-control" placeholder="Intitulé" type="text">
                          </div>
                        </div>
                  </div>  
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer">
                        <div style="width: 70%">
                          <textarea class="form-control" rows="3" placeholder="Résumé ..."></textarea>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="nom" class="form-control" placeholder="Partenaire" type="text">
                          </div>
                        </div>
                  </div> 
