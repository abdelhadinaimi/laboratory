...
<head>
  ...
  <title>LRI | Ajouter un article</title>
                ...
                <legend><center><h2><b>Nouvel article</b></h2></center></legend><br>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="noms" class="form-control" placeholder="Saisir les membres externes" type="text">
                          </div>
                        </div>
                  </div>  
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="ville" class="form-control" placeholder="Lieu " type="text">
                          </div>
                        </div>
                  </div> 
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="lieu_pay" class="form-control" placeholder="Lieu" type="text">
                          </div>
                        </div>
                  </div> 
