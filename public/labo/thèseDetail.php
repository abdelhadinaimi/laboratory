  ...
  <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="thèses.php">Thèses</a></li>
           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="box-body">
                  ...
                  <div class="col-md-9">
                    <p class="text-muted">
                      Le sujet ici:  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque.
                    </p>
                  </div>
