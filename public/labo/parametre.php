  ...
  <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="parametre.php">Paramètres</a></li>
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" action=" " method="post"  id="contact_form">
              <fieldset>
                ...
                <!-- Form Name -->
                <legend><center><h2><b>Informations Laboratoire</b></h2></center></legend><br>
              <div class="form-group ">
                        <label class="col-xs-4 control-label">Nom du labo</label>  
                        <div class="col-xs-8 inputGroupContainer">
                          <div style="width: 50%">
                            <input  name="nom_labo" class="form-control" placeholder="Le nom" type="text">
                          </div>
                        </div>
                  </div>  
