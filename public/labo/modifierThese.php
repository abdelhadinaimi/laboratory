...
<head>
  ...
  <title>LRI | Modifier une thèse</title>
 ...
 <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="thèses.php">Thèse</a></li>
                ...
                <legend><center><h2><b>Modifier thèse</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="titre" class="form-control" value="la QOS des réseaux mesh" type="text">
                          </div>
                        </div>
                  </div>  
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer">
                        <div style="width: 70%">
                          <textarea class="form-control" rows="3" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque."></textarea>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group ">
                   ...
                   <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="titre" class="form-control" placeholder="Nom" type="text">
                          </div>
                        </div>
                  </div> 
