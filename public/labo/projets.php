      ...
      <div class="col-md-12">
        <div class="box col-xs-12">
          ...
          <div class="row" style="padding-bottom: 20px">
            ...
            <div class="col-xs-1">
              <a href="ajouterProjet.php" type="button" class="btn btn-block btn-success btn-lg"><i class="fa fa-plus"></i></a>
            </div>
          </div>
          </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Type</th>
                  <th>Partenaires</th>
                  <th><a href="Profil.php"></a>Chef</th>
                  <th>Membres</th>
                  <th>Actions</th>
                </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>Télésurveillance via un réseau wifi mesh</td>
                    <td>Article court</td>
                    <td>société A</td>
                    <td>TADLAOUI</td>
                    <td>SETTOUTI<br>BOUIZEM<br>YOUNSI</td>
                    <td>
                      <div class="btn-group">
                        <a href="projetDetail.php" class="btn btn-info">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a href="modifierProjet.php" class="btn btn-default">
                  ...
                  <tr>
                    <td>La QOS d'un lien satellite pour l'accès internet</td>
                    <td>Revue</td>
                    <td>société B<br>société C</td>
                    <td>CHIKH</td>
                    <td>BAMBRIK<br>MAMCHAOUI<br>BENMOUSSAT</td>
                    <td>
                      <div class="btn-group">
                        <a href="projetDetail.php" class="btn btn-info">
                          <i class="fa fa-eye"></i>
