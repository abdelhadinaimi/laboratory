   ...
   <div class="content-wrapper" style="padding-top: 50px;">
    ...
    <section class="content" style="padding-top: 30px">
      <form class="well form-horizontal">
        <fieldset>
          <legend><center><h2><b>EQUIPES</b></h2></center></legend><br>
          <div class="row">
        <div class="col-xs-6">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <a class="users-list-name1" href="detailEquipe.php"><h3 class="widget-user-username">Equipes Systèmes & Communicants</h3></a>
              ...
              <div class="row">
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    ...
                    <span class="description-text">Mekkioui Zahera</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-xs-6">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-green">
              <a class="users-list-name1" href="detailEquipe.php"><h3 class="widget-user-username">Systèmes d'Information et Connaissances</h3></a>
              <h5 class="widget-user-desc">Founder &amp; CEO</h5>
            </div>
            <div class="widget-user-image">
            ...
            <div class="box-footer">
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header">47</h5>
                    <span class="description-text">Membres</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header">Chef d'équipe</h5>
                    <span class="description-text">Chikh Azeddine</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-xs-6">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-yellow">
              <a class="users-list-name1" href="detailEquipe.php"><h3 class="widget-user-username">Réseau, Services Distribués et Systèmes</h3></a>
              <h5 class="widget-user-desc">Founder &amp; CEO</h5>
            </div>
            <div class="widget-user-image">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header">Chef d'équipe</h5>
                    <span class="description-text">Didi Fedoua</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-xs-6">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-red">
              <a class="users-list-name1" href="detailEquipe.php"><h3 class="widget-user-username">Ingénierie logicielle sécurisée</h3></a>
              <h5 class="widget-user-desc">Founder &amp; CEO</h5>
            </div>
            <div class="widget-user-image">
