                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="tbl-cell hdr-menu">
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="{{url('front')}}" class="mdl-button mdl-js-button mdl-js-ripple-effect">Accueil
                                    <i class="fa fa-chevron-down"></i></a>
                                    <ul class="menu-dropdown">
                                        <li><a href="index.html">Accueil Style 1</a></li>
                                        <li><a href="index-1.html">Accueil Style 2</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('front/actualites')}}" class="mdl-button mdl-js-button mdl-js-ripple-effect">Actualités <i class="fa fa-chevron-down"></i></a>
                                    <ul class="menu-dropdown">
                                        <li><a href="index.html">Actualités Style 1</a></li>
                                        <li><a href="index-1.html">Actualités Style 2</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('front/projets')}}" class="mdl-button mdl-js-button mdl-js-ripple-effect">Projets <i class="fa fa-chevron-down"></i></a>
                                    <ul class="menu-dropdown">
                                        <li><a href="index.html">Projets Style 1</a></li>
                                        <li><a href="index-1.html">Projets Style 2</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('front/equipes')}}" class="mdl-button mdl-js-button mdl-js-ripple-effect">Equipes <i class="fa fa-chevron-down"></i></a>
                                    <ul class="menu-dropdown">
                                        <li><a href="index.html">Equipes Style 1</a></li>
                                        <li><a href="index-1.html">Equipes Style 2</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{url('front/contact')}}"  class="mdl-button mdl-js-button mdl-js-ripple-effect">Contact <i class="fa fa-chevron-down"></i></a>
                                    <ul class="menu-dropdown">
                                        <li><a href="index.html">Contact Style 1</a></li>
                                        <li><a href="index-1.html">Contact Style 2</a></li>
                                    </ul></li>
                                <li>
                                </li>
